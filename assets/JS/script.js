...
elementoBtn.addEventListener("click", ()=>{
    if(elementoBtn.value == "primeiro"){
        som = new Audio("./assets/SONGS/audio02.mp3")
        som.play();
        ...
        som = new Audio("./assets/SONGS/audio01.mp3")
        som.play();
        ...
        som = new Audio("./assets/SONGS/audio03.mp3")
        som.play();
        ...
        som = new Audio("./assets/SONGS/audio04.mp3")
        som.play();
